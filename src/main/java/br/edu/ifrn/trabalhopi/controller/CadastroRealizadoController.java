...
/*
* Objetivos: Essa é uma classe que para abrir uma tela com dois cards para o administrador
* 
...
public class CadastroRealizadoController {
	...
	public String pedidoFeito() {
		return "usuario/cadastrorealizado";
	}
